...
ventana = Tk()
ventana.title('EZE CALCULATOR')

#ICONO
ventana.iconbitmap("C:/Users/MINEDUCYT/Documents/Python/calsimple/fifi.ico")
...
#if e_texto == (ecuacion / 0):
#	e_texto.insert(0,'Error, intente de nuevo :)')



ventana.bind("<Return>", operate1)
...
boton_igual = Button(ventana, text = "=", width = 5, height = 2, command= lambda: operate())
